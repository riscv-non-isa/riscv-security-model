...
This repository holds specifications which defines a platform security model for RISC-V platforms.
...
Contributors to this specification are contained in the link:specification/src/contributors.adoc[contributors.adoc] file.
