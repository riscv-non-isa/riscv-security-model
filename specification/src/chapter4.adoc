...
For static partition TEE, using PMP/ePMP, with supervisor domains can be sufficient. PMA or svpam can also be used to assign physical memory attributes at system level, for example for system integration use cases.  
