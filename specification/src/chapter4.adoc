...
| Enforce access rules for devices
...
| Debug controls must be included in boot time measurement for attestation purpose.
| SR_DBG_006, SR_DBG_007, SR_DBG_008
...
| An application or domain must be protected against monitoring by other applications or domains
| SR_DBG_009, SR_DBG_010
