...
At implementation level there can be further distinctions, for example the degree of proximity or vicinity required to execute a remote or a physical attack. For the purpose of this document we are not making more fine grained distinctions than the ones listed above. 
