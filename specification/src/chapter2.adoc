...
| Fence.time, speculation barriers, transient execution barriers or similar future extensions, can mitigate 
against in-domain attacks (such as Spectre V1 , V4).
...
NOTE: The 'Future RISC-V mitigations' column identifies examples of architectural mechanisms that are currently under 
development or under discussion, and may become standard extensions. 
